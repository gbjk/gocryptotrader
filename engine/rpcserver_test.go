...
// GetCachedAccountHoldings overrides testExchange's fetch account info function
// to do the bare minimum required with no API calls or credentials required
func (f fExchange) GetCachedAccountHoldings(_ context.Context, a asset.Item) (account.Holdings, error) {
