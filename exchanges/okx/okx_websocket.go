...
// WsPlaceMultipleOrders creates an order through the websocket websocket.
...
// wsChannelSubscription sends a subscription or unsubscription request for different channels through the websocket websocket.
...
// wsAuthChannelSubscription send a subscription or unsubscription request for different channels through the websocket websocket.
