...
var (
	...
	errMissingRFQIDANDClientRFQID              = errors.New("missing rfq id or client supplied rfq id")
	...
	errMissingQuoteIDOrClientQuoteID           = errors.New("missing quote id or client supplied quote id")
	errMissingEitherQuoteIDAOrClientQuoteIDs   = errors.New("missing either quote ids or client supplied quote ids")
