...
func (w *Websocket) RemoveSubscription(s *subscription.Subscription) error {
	if w == nil || w.subscriptions == nil || s == nil {
		return common.ErrNilPointer
	}
	return w.subscriptions.Remove(s)
}

// RemoveSubscriptions removes subscriptions from the subscription list
func (w *Websocket) RemoveSubscriptions(subs subscription.List) error {
