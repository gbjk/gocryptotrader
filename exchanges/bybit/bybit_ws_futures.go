...
func (by *Bybit) SubscribeFutures(channelsToSubscribe []subscription.Subscription) error {
	var errs error
...
func (by *Bybit) UnsubscribeFutures(channelsToUnsubscribe []subscription.Subscription) error {
	var errs error
