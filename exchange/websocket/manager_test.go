...
func (_ *mockEx) GetAssetTypes(enabled bool) asset.Items             { return asset.Items{} }
func (_ *mockEx) GetEnabledPairs(asset.Item) (currency.Pairs, error) { return nil, nil }
func (_ *mockEx) CanUseAuthenticatedWebsocketEndpoints() bool        { return true }
func (_ *mockEx) IsAssetWebsocketSupported(a asset.Item) bool        { return true }
func (_ *mockEx) GetPairFormat(asset.Item, bool) (currency.PairFormat, error) {
	return currency.PairFormat{}, nil
}

func (_ *mockEx) GetSubscriptionTemplate(*subscription.Subscription) (*template.Template, error) {
	return nil, nil
}
func (_ *mockEx) GetSubscriptions() (subscription.List, error) { return nil, nil }
