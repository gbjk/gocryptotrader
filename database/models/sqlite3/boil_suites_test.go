...
func TestInsert(t *testing.T) {
	...
	t.Run("CandlesWhitelist", testCandlesInsertWhitelist)
	t.Run("Datahistoryjobs", testDatahistoryjobsInsert)
	t.Run("DatahistoryjobsWhitelist", testDatahistoryjobsInsertWhitelist)
	t.Run("Datahistoryjobresults", testDatahistoryjobresultsInsert)
	t.Run("DatahistoryjobresultsWhitelist", testDatahistoryjobresultsInsertWhitelist)
	...
	t.Run("ScriptExecutionsWhitelist", testScriptExecutionsInsertWhitelist)
	t.Run("Trades", testTradesInsert)
	t.Run("TradesWhitelist", testTradesInsertWhitelist)
	t.Run("WithdrawalCryptos", testWithdrawalCryptosInsert)
	t.Run("WithdrawalCryptosWhitelist", testWithdrawalCryptosInsertWhitelist)
	t.Run("WithdrawalFiats", testWithdrawalFiatsInsert)
	t.Run("WithdrawalFiatsWhitelist", testWithdrawalFiatsInsertWhitelist)
	t.Run("WithdrawalHistories", testWithdrawalHistoriesInsert)
	t.Run("WithdrawalHistoriesWhitelist", testWithdrawalHistoriesInsertWhitelist)
}
